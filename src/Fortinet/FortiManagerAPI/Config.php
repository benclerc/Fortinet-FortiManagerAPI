 ...
 * @property string $hostname FortiManager's FQDN.
 * @property string $username FortiManager user's valid username.
 * @property string $password FortiManager user's valid password.
...
class Config
{
	 ...
	 * @param string $hostname FortiManager's FQDN or IP address.
	 * @param string $username A valid firewall user.
	 * @param string $password The valid user's password.
	 * @return Config Config object to be passed on a new instance of different FortiManagerAPI class.
	 */
	 ...
	 * @return string FortiManager's FQDN.
	 */
	 ...
	 * @return Config Config object to be passed on a new instance of FortiManagerAPI object.
	 */
